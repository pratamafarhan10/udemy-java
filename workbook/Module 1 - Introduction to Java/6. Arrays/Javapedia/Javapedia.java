...
public class Javapedia {
    public static void main(String[] args) {
        ...
        // row.
        String[][] database = new String[numOfRecord][3];
    ...
    public static void search(String[][] record, String name) {
        for (int i = 0; i < record.length; i++) {
            if (record[i][0].equalsIgnoreCase(name)) {
                System.out.println("\tName:" + record[i][0]);
                System.out.println("\tDate of birth:" + record[i][1]);
                System.out.println("\tOccupation:" + record[i][2]);
            }
        }
    }
    ...
    public static void print2DArray(String[][] record) {
        for (int i = 0; i < record.length; i++) {
            System.out.print("\t");
